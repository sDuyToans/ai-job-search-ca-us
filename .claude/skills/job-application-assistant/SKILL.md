...
### Step 2: Tailor CV
- Read the most relevant existing CV variant from an existing `applications/*/<company>_<role>/cv.tex` (glob across date folders; or `cv/main_example.tex` if none exist yet) as a starting point
- Follow the guidelines in `05-cv-templates.md`
- Create `applications/<YYYY-MM-DD>/<company>_<role>/cv.tex` with tailored content
- Adjust: profile statement, skills section, experience bullet emphasis, section order

### Step 3: Write Cover Letter
- Follow the writing style rules in `03-writing-style.md` (critical: no em-dashes, no cliches)
- Follow the template structure in `06-cover-letter-templates.md`
- Create `applications/<YYYY-MM-DD>/<company>_<role>/cover_letter.tex` (symlink `cover.cls`/`OpenFonts` into the folder first — see `06-cover-letter-templates.md`)
