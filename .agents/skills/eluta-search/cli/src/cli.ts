#!/usr/bin/env bun
// Self-contained CLI for searching jobs on Eluta.ca's public search-results
// and job-detail HTML pages. No external CLI framework, so it runs anywhere
...
const HELP = `eluta-cli — search jobs on Eluta.ca
...
SEARCH FLAGS
  ...
  --location, -l <text>   Place string, e.g. "Ontario", "Toronto, ON".
...
Data is from Eluta.ca's public search and job-detail pages — Eluta indexes external
employer career pages. No authentication required.
`
